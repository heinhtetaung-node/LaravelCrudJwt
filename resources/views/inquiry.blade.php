                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('inquiry.create') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="radio" {{ (old('gender')=='male')? 'checked' : (old('gender')=='')? 'checked' : '' }} value="male" name="gender"> 男性
                                &nbsp;
                                <input type="radio" {{ (old('gender')=='female')? 'checked' : '' }} value="female" name="gender"> 女性 
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" style="height: 100px" name="message">{{ old('message') }}</textarea>
                            </div>
                        </div>
