...
return [
    ...
    */
    ...
    'gt'                   => [
        'numeric' => ':attributeは:valueより大きい数字を指定してください。',
        'file'    => ':attributeは、:value KBより大きいファイルを指定してください。',
        'string'  => ':attributeは、:value文字より大きい文字数にしてください。',
        'array'   => ':attributeの項目は、:valueより多い件数にしてください。',
    ],
    'gte'                  => [
        'numeric' => ':attributeは、:value以上以上の数字を指定してください。',
    ...
    'lt'                   => [
        'numeric' => ':attributeは、:valueより小さい数字を指定してください。',
        'file'    => ':attributeは、:value KBより小さいファイルを指定してください。',
        'string'  => ':attributeは、:value文字より小さい文字数にしてください。',
        'array'   => ':attributeは、:valueより少ない件数にしてください。',
    ],
    'lte'                  => [
        'numeric' => ':attributeは、:value以下の数字を指定してください。',
